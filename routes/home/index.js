...
router.get( '/', async ( req, res ) => {
  try {
    // send the data to the ejs template before rendering and sending the page as a response
    ...
    // console log 500 response code if an error occurs while executing the code
      res.sendStatus(500);    
  }
});
